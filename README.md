...
-endpoints partie demandé par le prof qui utilise des endpoints pour naviguer avec les recherches fait a partir d'une méthode de scrapping et qui affiche en json (expliquer chaque partie get data, articles, article, ml)
